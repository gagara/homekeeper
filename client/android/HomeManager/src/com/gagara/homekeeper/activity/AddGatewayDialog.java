...
public class AddGatewayDialog extends DialogFragment {
        ...
        builder.setPositiveButton(R.string.manage_node_button_ok,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        readValues();
                        if (listener != null) {
                            listener.doSwitchNodeState(AddGatewayDialog.this);
                        }
                    }
                });
        builder.setNegativeButton(R.string.manage_node_button_cancel,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        readValues();
                        if (listener != null) {
                            listener.doNotSwitchNodeState(AddGatewayDialog.this);
                        }
                    }
                });
    ...
    public interface SwitchNodeStateListener {
        ...
        public void doSwitchNodeState(AddGatewayDialog dialog);

        public void doNotSwitchNodeState(AddGatewayDialog dialog);
