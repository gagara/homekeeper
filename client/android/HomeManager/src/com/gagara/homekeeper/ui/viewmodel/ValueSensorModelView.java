...
public class ValueSensorModelView extends SensorModelView<ValueSensorModel> implements ModelView<ValueSensorModel> {

    private static final String DATE_FORMAT = "HH:mm dd/MM";

    public ValueSensorModelView(int id) {
        model = new ValueSensorModel(id);
    }
