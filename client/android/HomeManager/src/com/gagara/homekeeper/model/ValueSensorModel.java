...
import static com.gagara.homekeeper.model.ValueSensorModel.SensorType.TEMPERATURE;
...
public class ValueSensorModel extends SensorModel implements Model {
    ...
    public ValueSensorModel(int id) {
        this.id = id;
    }

    public ValueSensorModel(ValueSensorModel prev, int value) {
        super();
        this.id = prev.getId();
    ...
    public ValueSensorModel(ValueSensorModel prev, int value, Date timestamp) {
        this(prev, value);
    ...
    public void update(ValueSensorModel newModel) {
